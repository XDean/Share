package xdean.share.gui;

public class UIPeakClipping {
//
...
// * 
// * If use {@link Display#asyncExec(Runnable)} directly, all tasks will be called in one UI cycle. It may cause UI block
// * there. To avoid this defect, you should use this utility.
// * 
// * SwtRunCenter will limit the tasks to UI thread. If tasks have take more than {@link #FRAME_MILLIS} time, it will exit
...
// * @author XDean
// */
//public abstract class SwtRunCenter {
//
//  private static final long FRAME_MILLIS = 50;
//  private static final Map<Display, SwtContext> CONTEXTS = Collections.synchronizedMap(new WeakHashMap<>());
//
...
//
//    /**
//     * Set the display, by default use {@link Display#getCurrent()}
//     */
//    public Config display(Display d) {
//      display = d;
//      return this;
//    }
//
...
//      }
//      getContext(display).schedule(id, r);
//      if (wait) {
...
//  }
//
//  private static SwtContext getContext(Display d) {
//    return CONTEXTS.computeIfAbsent(d, k -> new SwtContext(k));
//  }
//
